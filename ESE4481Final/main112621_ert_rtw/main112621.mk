###########################################################################
## Makefile generated for component 'main112621'. 
## 
## Makefile     : main112621.mk
## Generated on : Sun Dec 12 18:48:13 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/main112621.so
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/main112621.so
...
DEFINES_STANDARD = -DMODEL=main112621 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_logging.o main112621.o main112621_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/main112621_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/main112621_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
main112621.o : $(START_DIR)/main112621_ert_rtw/main112621.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main112621_data.o : $(START_DIR)/main112621_ert_rtw/main112621_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/main112621_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/main112621_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/main112621_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
