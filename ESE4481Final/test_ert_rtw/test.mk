...
## 
## Makefile     : test.mk
## Generated on : Tue Nov 23 17:48:59 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test.so
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/parrot/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
OBJS = rt_logging.o rtGetInf.o rtGetNaN.o rt_nonfinite.o test.o test_data.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
rtGetInf.o : $(START_DIR)/test_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/test_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/test_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
