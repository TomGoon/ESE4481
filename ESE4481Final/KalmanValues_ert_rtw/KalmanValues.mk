###########################################################################
## Makefile generated for component 'KalmanValues'. 
## 
## Makefile     : KalmanValues.mk
## Generated on : Mon Dec 13 09:45:08 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/KalmanValues.so
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/KalmanValues.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/KalmanValues_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I/Users/Liza/Documents/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/parrot/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=KalmanValues -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_logging.o KalmanValues.o KalmanValues_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/KalmanValues_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/KalmanValues_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
KalmanValues.o : $(START_DIR)/KalmanValues_ert_rtw/KalmanValues.c
	$(CC) $(CFLAGS) -o "$@" "$<"


KalmanValues_data.o : $(START_DIR)/KalmanValues_ert_rtw/KalmanValues_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/KalmanValues_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/KalmanValues_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/KalmanValues_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
