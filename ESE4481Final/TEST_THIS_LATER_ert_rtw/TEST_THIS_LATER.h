...
#ifndef RTW_HEADER_TEST_THIS_LATER_h_
#define RTW_HEADER_TEST_THIS_LATER_h_
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef TEST_THIS_LATER_COMMON_INCLUDES_
#define TEST_THIS_LATER_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "rt_logging.h"
#endif                                 /* TEST_THIS_LATER_COMMON_INCLUDES_ */

#include "TEST_THIS_LATER_types.h"
...
} DW_TEST_THIS_LATER_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real32_T Motors[4];                  /* '<Root>/Motors' */
  uint8_T Flag;                        /* '<Root>/Flag' */
} ExtY_TEST_THIS_LATER_T;

/* Parameters (default storage) */
struct P_TEST_THIS_LATER_T_ {
...
struct tag_RTM_TEST_THIS_LATER_T {
...
extern P_TEST_THIS_LATER_T TEST_THIS_LATER_P;

/* Block states (default storage) */
extern DW_TEST_THIS_LATER_T TEST_THIS_LATER_DW;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_TEST_THIS_LATER_T TEST_THIS_LATER_Y;
...
extern void TEST_THIS_LATER_initialize(void);
extern void TEST_THIS_LATER_step(void);
extern void TEST_THIS_LATER_terminate(void);

/* Real-time Model object */
extern RT_MODEL_TEST_THIS_LATER_T *const TEST_THIS_LATER_M;
 ...
 *
 * '<Root>' : 'TEST_THIS_LATER'
 * '<S1>'   : 'TEST_THIS_LATER/Flight Control System'
 * '<S2>'   : 'TEST_THIS_LATER/Flight Control System/Subsystem'
 */
#endif                                 /* RTW_HEADER_TEST_THIS_LATER_h_ */
