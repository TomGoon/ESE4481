...
#ifndef RTW_HEADER_TEST_THIS_LATER_types_h_
#define RTW_HEADER_TEST_THIS_LATER_types_h_
#include "rtwtypes.h"
...
typedef struct P_TEST_THIS_LATER_T_ P_TEST_THIS_LATER_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_TEST_THIS_LATER_T RT_MODEL_TEST_THIS_LATER_T;

#endif                                 /* RTW_HEADER_TEST_THIS_LATER_types_h_ */
