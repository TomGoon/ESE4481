...
this.def["cmd_inport"] = {file: "final_project_c.html",line:25,type:"var"};
this.def["sensor_inport"] = {file: "final_project_c.html",line:26,type:"var"};
this.def["motors_outport"] = {file: "final_project_c.html",line:27,type:"var"};
this.def["flag_outport"] = {file: "final_project_c.html",line:28,type:"var"};
this.def["final_project_B"] = {file: "final_project_c.html",line:31,type:"var"};
this.def["final_project_DW"] = {file: "final_project_c.html",line:34,type:"var"};
this.def["final_project_Y"] = {file: "final_project_c.html",line:37,type:"var"};
this.def["final_project.c:final_project_M_"] = {file: "final_project_c.html",line:40,type:"var"};
this.def["final_project_M"] = {file: "final_project_c.html",line:41,type:"var"};
this.def["final_pr_MeasurementUpdate_Init"] = {file: "final_project_c.html",line:48,type:"fcn"};
this.def["final_MeasurementUpdate_Disable"] = {file: "final_project_c.html",line:63,type:"fcn"};
this.def["final_p_MeasurementUpdate_Start"] = {file: "final_project_c.html",line:80,type:"fcn"};
this.def["final_project_MeasurementUpdate"] = {file: "final_project_c.html",line:90,type:"fcn"};
this.def["final_pro_EnabledSubsystem_Init"] = {file: "final_project_c.html",line:134,type:"fcn"};
this.def["final__EnabledSubsystem_Disable"] = {file: "final_project_c.html",line:149,type:"fcn"};
this.def["final_pr_EnabledSubsystem_Start"] = {file: "final_project_c.html",line:166,type:"fcn"};
this.def["final_project_EnabledSubsystem"] = {file: "final_project_c.html",line:176,type:"fcn"};
this.def["final_project_step"] = {file: "final_project_c.html",line:214,type:"fcn"};
this.def["final_project_initialize"] = {file: "final_project_c.html",line:1774,type:"fcn"};
this.def["final_project_terminate"] = {file: "final_project_c.html",line:4194,type:"fcn"};
this.def["B_MeasurementUpdate_final_pro_T"] = {file: "final_project_h.html",line:87,type:"type"};
this.def["DW_MeasurementUpdate_final_pr_T"] = {file: "final_project_h.html",line:92,type:"type"};
this.def["B_EnabledSubsystem_final_proj_T"] = {file: "final_project_h.html",line:97,type:"type"};
this.def["DW_EnabledSubsystem_final_pro_T"] = {file: "final_project_h.html",line:102,type:"type"};
this.def["B_final_project_T"] = {file: "final_project_h.html",line:165,type:"type"};
this.def["DW_final_project_T"] = {file: "final_project_h.html",line:310,type:"type"};
this.def["ExtY_final_project_T"] = {file: "final_project_h.html",line:316,type:"type"};
this.def["CommandBus"] = {file: "final_project_types_h.html",line:38,type:"type"};
this.def["extraSensorData_t"] = {file: "final_project_types_h.html",line:49,type:"type"};
this.def["SensorsBus"] = {file: "final_project_types_h.html",line:60,type:"type"};
this.def["P_MeasurementUpdate_final_pro_T"] = {file: "final_project_types_h.html",line:65,type:"type"};
this.def["P_EnabledSubsystem_final_proj_T"] = {file: "final_project_types_h.html",line:68,type:"type"};
this.def["P_final_project_T"] = {file: "final_project_types_h.html",line:71,type:"type"};
this.def["RT_MODEL_final_project_T"] = {file: "final_project_types_h.html",line:74,type:"type"};
this.def["final_project_P"] = {file: "final_project_data_c.html",line:25,type:"var"};
