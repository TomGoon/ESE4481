...
P_final_project_T final_project_P = {
  ...
  /* Start of '<S94>/Enabled Subsystem' */
  {
    /* Expression: 0
  ...
  /* End of '<S94>/Enabled Subsystem' */

  /* Start of '<S87>/MeasurementUpdate' */
  {
    /* Expression: 0
  ...
  /* Start of '<S33>/MeasurementUpdate' */
  {
    /* Expression: 0
