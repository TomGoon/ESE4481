###########################################################################
## Makefile generated for component 'model_112321'. 
## 
## Makefile     : model_112321.mk
## Generated on : Fri Nov 26 15:50:05 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/model_112321.so
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/model_112321.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/model_112321_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I/Users/Liza/Documents/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/parrot/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=model_112321 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_logging.o model_112321.o model_112321_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/model_112321_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/model_112321_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
model_112321.o : $(START_DIR)/model_112321_ert_rtw/model_112321.c
	$(CC) $(CFLAGS) -o "$@" "$<"


model_112321_data.o : $(START_DIR)/model_112321_ert_rtw/model_112321_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/model_112321_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/model_112321_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/model_112321_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
